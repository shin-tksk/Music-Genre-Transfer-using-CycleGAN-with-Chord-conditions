...
def get_bar_piano_roll(piano_roll):
    if int(piano_roll.shape[0] % (RESOLUTION*16)) != 0:
        ...
        #    piano_roll = np.concatenate((piano_roll, np.zeros((16 - piano_roll.shape[0] % 64, 128))), axis=0)
...
if not os.path.exists(os.path.join(ROOT_PATH, 'MIDI/{}/{}_{}/chord_mid'.format(GENRU,GENRU,MODE))):
    os.makedirs(os.path.join(ROOT_PATH, 'MIDI/{}/{}_{}/chord_mid'.format(GENRU,GENRU,MODE)))

tonnetz.detect_chord_key()


"""6. concatenate into a big binary numpy array file"""
...
if not os.path.exists(os.path.join(ROOT_PATH, 'MIDI/{}/{}_{}/phrase_midi'.format(GENRU,GENRU,MODE))):
    os.makedirs(os.path.join(ROOT_PATH, 'MIDI/{}/{}_{}/phrase_midi'.format(GENRU,GENRU,MODE)))
