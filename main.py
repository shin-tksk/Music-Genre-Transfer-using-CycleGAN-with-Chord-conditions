...
parser.add_argument('--time_step', dest='time_step', type=int, default=192, help='time step of pianoroll')
parser.add_argument('--pitch_range', dest='pitch_range', type=int, default=96, help='pitch range of pianoroll')
...
parser.add_argument('--L1_lambda', dest='L1_lambda', type=float, default=15.0, help='weight on L1 term in objective')
