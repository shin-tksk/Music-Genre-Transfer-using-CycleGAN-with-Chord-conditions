...
class Classifer(object):
    ...
    def train(self, args):
        ...
        log_dir = './logs/classifier_{}2{}_{}_{}'.format(self.dataset_A_dir, self.dataset_B_dir, '2022-05-08',
                                                         str(self.sigma_c))
    ...
    def save(self, checkpoint_dir, step):
        ...
        model_dir = "classifier_{}2{}_2022-05-08_{}".format(self.dataset_A_dir, self.dataset_B_dir,
                                                    str(self.sigma_c))
    ...
    def test(self, args):
        ...
        sample_files_origin = glob('./test/{}2{}_2022-05-08_{}_{}/{}/npy/origin/*.*'.format(self.dataset_A_dir,
                                                                                    self.dataset_B_dir,
                                                                                    self.model,
                                                                                    self.sigma_d,
        ...
        # load the origin samples in npy format and sorted in ascending order
        sample_files_transfer = glob('./test/{}2{}_2022-05-08_{}_{}/{}/npy/transfer/*.*'.format(self.dataset_A_dir,
                                                                                        self.dataset_B_dir,
                                                                                        self.model,
                                                                                        self.sigma_d,
                                                                                        args.which_direction))
        ...
        # load the origin samples in npy format and sorted in ascending order
        sample_files_cycle = glob('./test/{}2{}_2022-05-08_{}_{}/{}/npy/cycle/*.*'.format(self.dataset_A_dir,
                                                                                  self.dataset_B_dir,
                                                                                  self.model,
                                                                                  self.sigma_d,
                                                                                  args.which_direction))
